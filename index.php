...
<?php while ( $result->have_posts() ) : $result->the_post(); ?>
   ...
   <?php endif; ?>
                                        ...
                                        <div class="container">
                                            ...
                                            ?>
                                          <h5>Written by <span class="opacity"><?php echo get_the_author() ?> </span> at  <span class="opacity"><?php echo get_the_date( 'Y-m-d' ); ?> , <?php the_time( 'H:i:s' ); ?></span> in <?php  if ( ! empty( $postcat ) ) {echo esc_html( $postcat[0]->name );
                                                                                                                                                                                                                                                                                   } ?></h5>
                                        </div>
